            ...
            <div class="flex bg-white rounded-lg shadow-2xl overflow-hidden mx-auto max-w-sm lg:max-w-4xl">
                ...
                <div class="w-full p-8 lg:w-1/2">
                    ...
                    <div class="mt-4">
                        ...
                        <input class="bg-gray-200 text-gray-700 focus:outline-none focus:shadow-outline border border-gray-300 rounded py-2 px-4 block w-full appearance-none" type="email" name="email" onChange={handleChangeInput} />
                    </div>
                    <div class="mt-4">
                        ...
                        <input class="bg-gray-200 text-gray-700 focus:outline-none focus:shadow-outline border border-gray-300 rounded py-2 px-4 block w-full appearance-none" type="password" name="password" onChange={handleChangeInput} />
                    </div>
                    <div class="mt-8">
                        <button class="bg-gray-700 text-white font-bold py-2 px-4 w-full rounded hover:bg-gray-600" onClick={handleLoginSubmit}>Login</button>
                    </div>
                    <div class="mt-4 flex items-center justify-between">

...
const ItemDetail = (props) => {
    ...
    return (
        <div className="mt-10 flex gap-8">
            ...
            <div className="">
                <h1 className="font-medium text-2xl mb-3 lowercase first-letter:uppercase">{product.name}</h1>
                {/* <div>
                    <svg
                ...
                <div>
                    <div className="text-2xl text-[#02c4c1] font-bold mb-3">{Intl.NumberFormat('vi-VN', { style: 'currency', currency: 'VND' }).format(product.price)}</div>
                ...
                <div className='w-3/4 bg-[#ff6683] mb-3'>
                    <button className="w-full py-2 text-white font-semibold duration-500 hover:bg-[#02c4c1]" onClick={(e) => { e.preventDefault(); addToCart(product) }}>THÊM VÀO GIỎ</button>
                </div>
